window.addEventListener('load', function () {
 ...
 setTimeout(function () {
    ...
    setTimeout(function () {     
         document.getElementById("ccm").remove();
     }, 2000);
     }, 8000);
  })
